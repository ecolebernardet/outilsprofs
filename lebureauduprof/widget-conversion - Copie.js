...
function createConversionWidget(opts) {
    ...
    helpPopup.className = 'wconv-help-popup';
        ...
        "S&#233;lectionnez le <b>type de mesure</b> (longueurs, masses, etc.), le <b>nombre d&#39;exercices</b> et le <b>niveau de difficult&#233;</b>. Cliquez sur <em>G&#233;n&#233;rer</em> pour cr&#233;er la fiche." +
        "</div>" +
        '<div class="help-section">' +
        "<strong>2. Comprendre les niveaux</strong>" +
        '<ul style="margin:5px 0 0 14px;padding:0;line-height:1.6;">' +
        "<li><b>Facile</b> : Uniquement des nombres entiers. Les conversions se font toujours vers une unit&#233; plus petite (vers la droite), garantissant des r&#233;sultats sans virgule.</li>" +
        "<li><b>Moyen</b> : Les nombres de d&#233;part sont entiers, mais les conversions peuvent aller dans les deux sens. La virgule peut appara&#238;tre dans la r&#233;ponse.</li>" +
        "<li><b>Difficile</b> : Tout est possible. Le nombre de d&#233;part peut &#234;tre d&#233;cimal et l&#39;&#233;cart entre les unit&#233;s est al&#233;atoire.</li>" +
        "</ul>" +
        '<p style="margin:6px 0 0;font-style:italic;">💡 Les modes Moyen et Difficile incluent 20% de questions du niveau inf&#233;rieur pour encourager l&#39;&#233;l&#232;ve.</p>' +
        "</div>" +
        '<div class="help-section">' +
        "<strong>3. Correction</strong><br>" +
        "Cliquez sur 👁 pour v&#233;rifier les r&#233;ponses. Les bonnes r&#233;ponses deviennent <b style='color:#1a7a3a'>vertes</b> et sont conserv&#233;es. Les erreurs apparaissent en <b style='color:#9c1c28'>rouge</b>." +
        "</div>"
    );
