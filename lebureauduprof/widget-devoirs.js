...
(function () {
    ...
    <div class="editor-container">
        <div class="editor-content" contenteditable="true" oninput="saveBoard()" style="line-height:1.3;">
			...
			<br>
            <span style="color:#f7639f;font-size:35px;font-weight:bold;">&nbsp;&nbsp;🔴 CE2 =</span><br><br>
			<span style="color:#12a2e0;font-size:35px;font-weight:bold;">&nbsp;&nbsp;🔵 CM2 =</span><br><br>
            <span style="color:#1e6337;font-size:35px;font-weight:bold;">&nbsp;&nbsp;🟢 TOUS =</span><br><br>
        </div>
    </div>`;
